...
| 2026-02-20-007 | 2026-02-20 | codex | initialize_project | PRD-01-minimal internal-notes-assistant re-run (no material changes) | S30-examples/test-runs/2026-02-27-initialize-project-prd-01-run-report.md; src/; tests/ | S20-workflows/run-ledger.md; S20-workflows/task.md | draft | none | uncommitted | Run report saved with requested 2026-02-27 filename; canonical artifacts already existed in versioned form. |
